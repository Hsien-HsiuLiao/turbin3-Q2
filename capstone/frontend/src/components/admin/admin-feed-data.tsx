...
export function FeedAccountData() {
        ...
        {loading ? (
          ...
          <div className="space-y-2 text-sm">
            <div className="font-medium text-gray-800">
              ...
              <span className="text-gray-700 ml-2">{ellipsify(feedData.address)}</span>
            </div>
            <div className="font-medium text-gray-800">
              <span className="font-semibold">Owner:</span>
              <span className="text-gray-700 ml-2">{ellipsify(feedData.owner)}</span>
            </div>
            <div className="font-medium text-gray-800">
              <span className="font-semibold">Balance:</span>
              <span className="text-gray-700 ml-2">{(feedData.lamports / 1000000000).toFixed(9)} SOL</span>
            </div>
            <div className="font-medium text-gray-800">
              <span className="font-semibold">Data Size:</span>
              <span className="text-gray-700 ml-2">{feedData.dataSize} bytes</span>
            </div>
            <div className="font-medium text-gray-800">
              <span className="font-semibold">Executable:</span>
              <span className="text-gray-700 ml-2">{feedData.executable ? 'Yes' : 'No'}</span>
            </div>
            <div className="font-medium text-gray-800">
              <span className="font-semibold">Rent Epoch:</span>
              <span className="text-gray-700 ml-2">{feedData.rentEpoch}</span>
            </div>
            
            {/* Parsed Feed Data */}
            {feedData.parsedData && (
              <div className="mt-4 pt-4 border-t border-gray-300">
                <div className="font-semibold text-gray-900 mb-2">Parsed Feed Data:</div>
                <div className="space-y-1 text-xs">
                  <div className="font-medium text-gray-800">
                    <span className="font-semibold">Data Length:</span>
                    <span className="text-gray-700 ml-2">{feedData.parsedData.dataLength || 0} bytes</span>
                  </div>
                  <div className="font-medium text-gray-800">
                    <span className="font-semibold">Has Data:</span>
                    <span className="text-gray-700 ml-2">{feedData.parsedData.hasData ? 'Yes' : 'No'}</span>
                  </div>
                  {feedData.parsedData.rawDataLength !== undefined && (
                    <div className="font-medium text-gray-800">
                      <span className="font-semibold">Raw Base64 Length:</span>
                      <span className="text-gray-700 ml-2">{feedData.parsedData.rawDataLength} chars</span>
                    </div>
                  )}
                  <div className="font-medium text-gray-800">
                    <span className="font-semibold">Account Discriminator:</span>
                    <span className="text-gray-700 ml-2 font-mono">{feedData.parsedData.discriminator}</span>
                  </div>
                  <div className="font-medium text-gray-800">
                    <span className="font-semibold">Queue Pubkey:</span>
                    <span className="text-gray-700 ml-2 font-mono">{feedData.parsedData.queuePubkeyReadable}</span>
                  </div>
                  <div className="font-medium text-gray-800">
                    <span className="font-semibold">Min Oracle Results:</span>
                    <span className="text-gray-700 ml-2">{feedData.parsedData.minOracleResults} oracles</span>
                  </div>
                  <div className="font-medium text-gray-800">
                    <span className="font-semibold">Min Job Results:</span>
                    <span className="text-gray-700 ml-2">{feedData.parsedData.minJobResults} jobs</span>
                  </div>
                  <div className="font-medium text-gray-800">
                    <span className="font-semibold">Min Update Delay:</span>
                    <span className="text-gray-700 ml-2">{feedData.parsedData.minUpdateDelayReadable}</span>
                  </div>
                  <div className="font-medium text-gray-800">
                    <span className="font-semibold">Latest Update:</span>
                    <span className="text-gray-700 ml-2">{feedData.parsedData.latestRoundTimestampReadable}</span>
                  </div>
                  <div className="font-medium text-gray-800">
                    <span className="font-semibold">Latest Value:</span>
                    <span className="text-gray-700 ml-2">{feedData.parsedData.latestRoundResultReadable}</span>
                  </div>
                  <div className="font-medium text-gray-800">
                    <span className="font-semibold">Round Status (Success Count):</span>
                    <span className="text-gray-700 ml-2">{feedData.parsedData.roundStatus}</span>
                  </div>
                  <div className="font-medium text-gray-800">
                    <span className="font-semibold">Feed Status:</span>
                    <span className="text-gray-700 ml-2">{feedData.parsedData.feedStatus}</span>
                  </div>
                  
                  {/* Raw hex data for debugging */}
                  <div className="mt-4 pt-4 border-t border-gray-300">
                    <div className="font-semibold text-gray-900 mb-2">Raw Hex Data Analysis:</div>
                    <div className="space-y-2 text-xs">
                      {/* First 16 bytes - Account discriminator */}
                      <div className="bg-gray-50 p-2 rounded">
                        <div className="font-semibold text-gray-900 mb-1">Account Discriminator (First 16 bytes):</div>
                        <div className="font-medium text-gray-800">
                          <span className="font-semibold">Hex:</span>
                          <span className="text-gray-700 ml-2 font-mono">{feedData.parsedData.firstBytes}</span>
                        </div>
                        <div className="font-medium text-gray-800">
                      ...
                      <div className="bg-gray-50 p-2 rounded">
                        <div className="font-semibold text-gray-900 mb-1">Queue Configuration (Bytes 32-48):</div>
                        <div className="font-medium text-gray-800">
                          <span className="font-semibold">Hex:</span>
                          <span className="text-gray-700 ml-2 font-mono">{feedData.parsedData.bytes32to48}</span>
                        </div>
                        <div className="font-medium text-gray-800">
                      ...
                      <div className="bg-gray-50 p-2 rounded">
                        <div className="font-semibold text-gray-900 mb-1">Configuration Values (Bytes 64-80):</div>
                        <div className="font-medium text-gray-800">
                          <span className="font-semibold">Hex:</span>
                          <span className="text-gray-700 ml-2 font-mono">{feedData.parsedData.bytes64to80}</span>
                        </div>
                        <div className="font-medium text-gray-800">
                      ...
                      <div className="bg-gray-50 p-2 rounded">
                        <div className="font-semibold text-gray-900 mb-1">Additional Data Slices:</div>
                                  ...
                                  return (
                                    <div key={index} className="border-l-2 border-gray-300 pl-2">
                                      <div className="font-medium text-gray-800">
                                        ...
                                        <span className="text-gray-700 ml-2 font-mono">{hexData}</span>
                                      </div>
                                      <div className="font-medium text-gray-800">
                                        <span className="font-semibold">ASCII:</span>
                                        <span className="text-gray-700 ml-2 font-mono">{asciiData}</span>
                                      </div>
                                    </div>
                                  );
                                }
          ...
          <div className="text-sm text-gray-800">No feed data available</div>
        )}
      </div>
    </div>
  );
